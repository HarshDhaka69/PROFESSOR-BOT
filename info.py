...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1001619360770').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5190315686').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002122074830')
...
# url shortner
SHORT_URL = environ.get("SHORT_URL", 'publicearn.com' )
SHORT_API = environ.get("SHORT_API", '977134c543fa3ce6ae184a7b9b7643b31ac42ddc')

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001895808400))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'The_Helping_Club')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001993446388')).split()]
